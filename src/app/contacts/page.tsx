...
export default function Contact() {
  return (
    <div>
      <h1 className="text-white text-center mt-14 text-xs md:text-3xl font-bold font-serif mb-16 animate__animated animate__fadeInDown">
        Connect With Me
      </h1>
      <div className="text-slate-200 grid md:p-5 md:grid-cols-2 lg:grid-cols-4 lg:p-0  justify-center max-w-xs md:max-w-5xl items-center mx-auto gap-10  text-sm md:text-base animate__animated animate__fadeInDown">
        <a
          ...
          target="_blank"
          className="border-2 border-black p-10  flex flex-col justify-center items-center rounded-lg bg-stone-500 hover:bg-stone-600 cursor-pointer "
        >
        ...
        >
          ...
          <p className="truncate">+62 882 6489 4239</p>
        </a>
        <a
          href="https://twitter.com/BasherZorro"
          target="_blank"
          className="border-2 border-black p-10  flex flex-col justify-center items-center rounded-lg bg-stone-500 hover:bg-stone-600 cursor-pointer "
        >
        ...
        <a
          href="https://stackoverflow.com/users/16142626/josua"
          target="_blank"
          className="border-2 border-black p-10  flex flex-col justify-center items-center rounded-lg bg-stone-500 hover:bg-stone-600 cursor-pointer "
        >
